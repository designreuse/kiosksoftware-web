<%-- 
    Document   : super_header
    Created on : 21 Sep, 2015, 12:18:15 PM
    Author     : parwez
--%>
...
<header class="main-header">
    ...
    <a href="dashboard.jsp?type=already_loggedin&opt=<%=session.getId()%>" class="logo">
        ...
        <span class="logo-lg"><b><%=config.getServletContext().getInitParameter("projectname")%></b></span>
    </a>
        ...
        <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<%=request.getContextPath()%>/uploads/<%=session.getAttribute("image")%>" class="user-image" alt="User Image"/>
