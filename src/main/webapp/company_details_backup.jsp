                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                java.sql.ResultSet rs = st.executeQuery("SELECT * FROM loyalty_customer_reg_details WHERE cus_id='" + cus_id + "'");
                                                while (rs.next()) {
                                                    count++;
                                            %>
                                            <tr>
                                                ...
                                                <td><a href="Edit_companydetails.jsp?id=<%=rs.getString("cus_id")%>&opt=<%=session.getId()%>">Edit</a> </td>     
                                            </tr>
                                            <%}%>
                                        </tbody>
                                        <%} catch (Exception e) {
