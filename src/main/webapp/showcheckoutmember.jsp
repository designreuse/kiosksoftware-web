<%-- 
    Document   : showcheckoutmember
    Created on : 12 Oct, 2015, 11:27:20 AM
    Author     : parwez
--%>
                                ...
                                <div class="box-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        while (rstotalpointipck.next()) {
                                                ...
                                                java.sql.ResultSet rs = st.executeQuery("SELECT * FROM loyalty_member_login_info_datewise WHERE kiosk_id='" + rstotalpointipck.getString("allocate_ip") + "' && status='Check Out'");
                                                while (rs.next()) {
                                                    count++;
