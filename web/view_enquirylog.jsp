<%-- 
    Document   : view_enquirylog
    Created on : 18 Aug, 2015, 2:27:43 PM
    Author     : parwez
--%>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                java.sql.ResultSet rs = st.executeQuery("SELECT * FROM loyalty_Enquiry_log_details");
                                                while (rs.next()) {
                                                    count++;
                                            %>
                                            <tr>
                                                <td> <%=count%></td> 
                                                <td> <%=rs.getString("Enquiry_type")%></td>     
