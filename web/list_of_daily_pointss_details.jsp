...
<html>
    <head>
        <meta charset="UTF-8">
        <title><%=config.getServletContext().getInitParameter("projectname")%> | Daily Point Details</title>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <form action="list_of_daily_points_gain.jsp" method="post" class="form-control">

                                        <select name="member_id"  >
                                            <%                     java.sql.Statement st = conn.createStatement();
                                                java.sql.ResultSet rss = st.executeQuery("SELECT * FROM loyalty_daily_purchase_details");
                                                while (rss.next()) {
                                            %>
