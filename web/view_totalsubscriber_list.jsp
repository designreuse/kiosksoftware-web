<%-- 
    Document   : view_totalsubscriber_list
    Created on : 19 Aug, 2015, 1:26:06 PM
    Author     : parwez
--%>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                java.sql.ResultSet rs = st.executeQuery("SELECT * FROM loyalty_total_subscriber_list");
                                                while (rs.next()) {
                                                    count++;
                                            %>
                                            <tr>
