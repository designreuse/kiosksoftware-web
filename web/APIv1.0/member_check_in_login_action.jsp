...
<%    JSONObject jobj = new JSONObject();
    ...
    try {
        ...
        if (status.equals("Check In")) {
            ...
            PreparedStatement pst = conn.prepareStatement("INSERT INTO loyalty_member_login_info_datewise(member_id,kiosk_id,status,flag,points) VALUES(?,?,?,?,?)");
            ...
            PreparedStatement pst = conn.prepareStatement("INSERT INTO loyalty_member_login_info_datewise(member_id,kiosk_id,status,flag) VALUES(?,?,?,?)");
            pst.setString(1, member_id);
            pst.setString(2, kiosk_id);
            pst.setString(3, status);
            pst.setString(4, "0");
