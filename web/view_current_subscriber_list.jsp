<%-- 
    Document   : view_current_subscriber_list
    Created on : 19 Aug, 2015, 1:25:03 PM
    Author     : parwez
--%>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Current Subscriber List Details
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                java.sql.ResultSet rs = st.executeQuery("SELECT * FROM loyalty_current_subscriber_list");
                                                while (rs.next()) {
                                                    count++;
                                            %>
                                            <tr>
