<%-- 
    Document   : editmember
    Created on : 8 Sep, 2015, 11:59:25 AM
    Author     : parwez
--%>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="row">
                        ...
                        <form role="form" action="Edit_Member.jsp" name="form" method="post">
                            <div class="col-md-6">
                                ...
                                <div class="box box-primary">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <%
                                            ...
                                            java.sql.ResultSet rsuser = stuser.executeQuery("select * from sengroup_new_member_reg_details where id='" + request.getParameter("id") + "'");
                                            while (rsuser.next()) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="first_nm" name="first_nm" value="<%=rsuser.getString("fullname")%>" placeholder="Enter Full Name" required="">
                                        </div>
                                        <div class="form-group">
                                            <label>Member Id</label>
                                            <input type="text" class="form-control" id="member_id" readonly="" name="member_id" value="<%=rsuser.getString("member_id")%>" placeholder="Enter Member ID" required="">
                                        </div>
                                        <div class="form-group">
                                            <label> Status</label>
                                ...
                                <div class="box box-warning">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="address" id="address" value="<%=rsuser.getString("present_address")%>"  placeholder="Enter Address" required="">

                                        </div>
                                        <div>
                                            <label>Mobile Phone</label>

                                            <input type="text" class="form-control" name="mobile" id="mobile" value="<%=rsuser.getString("phone_no")%>" placeholder=" Mobile" required="">
                                        ...
                                        <div>
                                            ...
                                            <input type="number" class="form-control"  name="point"  id="point" value="<%=rsuser.getString("points")%>" placeholder="Bonus Points" required="">
                                        </div>
                                        <%}%>
