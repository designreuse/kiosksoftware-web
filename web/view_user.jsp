<%-- 
    Document   : view_user
    Created on : 3 Jul, 2015, 6:41:07 PM
    Author     :sukanya
--%>
                    ...
                    <div class="row">
                        ...
                        <%
                            ...
                            try {
                                ...
                                java.sql.ResultSet rs = st.executeQuery("SELECT * FROM loyalty_user_reg_details WHERE id='" + id + "' ");
                                while (rs.next()) {%>
                                ...
                                <div class="box box-primary">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" readonly="" name="cno" id="cno" value="<%= rs.getString("contact_no")%>">
                                        </div>
                                        <div>
                                            <label> Present State </label>
                                            <input type="text" readonly="" class="form-control" name="ps" id="ps" value="<%= rs.getString("present_state")%>">
                                        </div>

                                        <div class="form-group">
                                            <label> Present District</label>
                                            <input type="text" class="form-control" name="pre_dis" readonly="" id="pre_dis" value="<%= rs.getString("present_dist")%>">

                                        </div>
                                        <div class="form-group">
                                            <label> Present Pin Code</label>
                                            <input type="text" class="form-control" name="present_pin_code" readonly="" id="present_pin_code" value="<%= rs.getString("present_pin_code")%>">

                                        </div>
                                        <div class="form-group">
                                            <label> Present Address</label>
                                            <input type="text" class="form-control" name="present_address" id="	present_address"  readonly="" value="<%= rs.getString("	present_address")%>">

                                        </div>
                                        <div class="form-group">
                                            <label> Designation</label>
                                            <input type="text" class="form-control" name="designation" id="designation"  readonly=""value="<%= rs.getString("designation")%>">

                                        </div>
                                        <div class="form-group">
                                            <label> User Type</label>
                                            <input type="text" class="form-control" name="user_type" id="user_type" readonly="" value="<%= rs.getString("user_type")%>">

                                        </div>
                                        <div class="form-group">
                                            <label> Admin Code</label>
                                            <input type="text" class="form-control" name="admin_code" readonly="" id="admin_code" value="<%= rs.getString("admin_code")%>">
                                        ...
                                        <div class="form-group">
                                            <label> Status</label>
                                            <input type="text" class="form-control" name="pin_code" readonly="" id="pin_code" value="<%= rs.getString("status")%>">

                                        </div>
                                        <div class="form-group">
                                            <label> User Name</label>
                                            <input type="text" class="form-control" name="user_name" readonly="" id="user_name" value="<%= rs.getString("user_name")%>">

                                        </div>
                                        <div class="form-group">
                                            <label> Password</label>
                                            <input type="text" class="form-control" name="password" readonly="" id="password" value="<%= rs.getString("password")%>">
