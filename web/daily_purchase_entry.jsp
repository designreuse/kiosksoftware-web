            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="row">
                        ...
                        <form role="form" action="<%=request.getContextPath()%>/Daily_Purchase_Entry" method="POST" >
                                ...
                                <div class="box box-primary">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div>
                                            ...
                                            <input type="number" class="form-control" name="total_points" id="total_points" placeholder="Total Price" required="">
                                       </div>
                                        <div class="form-group">
                                            <label> Date</label>
